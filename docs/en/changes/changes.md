...
* Add PHP runtime PHM meter analyzer (`php-runtime.yaml`) for SkyWalking PHP agent process
  ...
  layer; `php-runtime` is included in the default `meterAnalyzerActiveFiles`. See
  [PHP runtime metrics dashboard](../setup/backend/dashboards-php-runtime.md).
...
* Add [PHP runtime metrics (PHM)](../setup/backend/dashboards-php-runtime.md) dashboard
  documentation (agent setup, OAP `php-runtime` MAL rules, Horizon UI widgets).
