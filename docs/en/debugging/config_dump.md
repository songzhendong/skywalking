...

{
   ...
   "agent-analyzer.default.meterAnalyzerActiveFiles":"datasource,threadpool,satellite,go-runtime,python-runtime,nodejs-runtime,continuous-profiling,java-agent,go-agent",
