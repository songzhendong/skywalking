...
OAP parses them with [MAL](../../concepts-and-designs/mal.md) rules in `php-runtime.yaml` and stores
...
Refer to the [PHP agent README](https://skywalking.apache.org/docs/skywalking-php/latest/en/setup/service-agent/php-agent/)
and [INI settings](https://skywalking.apache.org/docs/skywalking-php/latest/en/configuration/ini-settings/)
for details.
...
| Count | instance_php_thread_count                | meter_instance_php_thread_count            | OS thread count (Threads from /proc)    | SkyWalking PHP Agent |
| Count | instance_php_open_fd_count               | meter_instance_php_open_fd_count           | Open file descriptor count              | SkyWalking PHP Agent |
