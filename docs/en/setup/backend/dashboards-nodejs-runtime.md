...
| :--- | :--- | :--- |
| `SW_AGENT_RUNTIME_METRICS_REPORTER_ACTIVE` | Master switch for runtime metric export | `true` |
| `SW_AGENT_RUNTIME_METRICS_COLLECT_PERIOD` | Sample interval (ms) | `1000` |
| `SW_AGENT_RUNTIME_METRICS_REPORT_PERIOD` | Report interval (ms) | `1000` |
| `SW_AGENT_RUNTIME_METRICS_BUFFER_SIZE` | Max buffered samples before dropping oldest | `600` |
